...
import com.isyeriegitimi.backend.components.CustomAuthenticationEntryPoint;
import com.isyeriegitimi.backend.exceptions.CustomAccessDeniedHandler;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .requestMatchers("/auth/**","/swagger-ui/**","/v3/api-docs/**","/students/saveStudent","/commissions/save","/lecturer/saveLecturer","/company/saveCompany","emails/**").permitAll()
